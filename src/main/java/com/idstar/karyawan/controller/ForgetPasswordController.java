...
import com.idstar.karyawan.dao.request.ResetPasswordModel;
...
public class ForgetPasswordController {
    ...
    public Map sendEmailPassword(@RequestBody ResetPasswordModel user) {
        ...
        emailSender.sendAsync(found.getUsername(), "Aplikasi - Forget Password", template);
    ...
    public Map<String, String> resetPassword(@RequestBody ResetPasswordModel model) {
        ...
        if (model.getConfirmNewPassword() == null)
            return response.notFound("New Confirm Password " + config.isRequired);
        if (model.getEmail() == "") {
            return response.Error("Fill the email");
        }
